...
║  DOMAINS       :  Cybersecurity | IoT | AI | Networking  ║
...
<!-- AI / ML -->
![AI](https://img.shields.io/badge/Artificial_Intelligence-000000?style=for-the-badge&logo=openai&logoColor=00FFFF)
![TensorFlow](https://img.shields.io/badge/TensorFlow-000000?style=for-the-badge&logo=tensorflow&logoColor=9B00FF)
...
`ESP32` `WiFi 802.11` `BLE/Bluetooth` `Cybersecurity` `Networking`
...
objectives = {
    ...
    "🤖 AI & ML"          : "Exploring machine learning & AI integration",
    "📊 Trading"          : "Learning markets, analysis & mindset",
    "🔐 End Goal"         : "AI Engineer | Cybersecurity Engineer | Security Researcher",
}
```
